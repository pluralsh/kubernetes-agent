...
//
//	mockgen -source reconcile_trigger.go -destination mock_reconciler_trigger_for_test.go -package agent reconcileTrigger
//
...
func (mr *MockreconcileTriggerMockRecorder) reconcile(ctx, webhookPath any) *gomock.Call {

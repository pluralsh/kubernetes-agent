...
func (mr *MockprojectReconcilerMockRecorder) ReconcileIndexedProjects(ctx any) *projectReconcilerReconcileIndexedProjectsCall {
	...
	return &projectReconcilerReconcileIndexedProjectsCall{Call: call}
}

// projectReconcilerReconcileIndexedProjectsCall wrap *gomock.Call
type projectReconcilerReconcileIndexedProjectsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *projectReconcilerReconcileIndexedProjectsCall) Return() *projectReconcilerReconcileIndexedProjectsCall {
	c.Call = c.Call.Return()
	return c
}

// Do rewrite *gomock.Call.Do
func (c *projectReconcilerReconcileIndexedProjectsCall) Do(f func(context.Context)) *projectReconcilerReconcileIndexedProjectsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *projectReconcilerReconcileIndexedProjectsCall) DoAndReturn(f func(context.Context)) *projectReconcilerReconcileIndexedProjectsCall {

...
//
//	mockgen -source worker_manager.go -destination mock_for_test.go -package modagent
//
...
func (mr *MockWorkerFactoryMockRecorder[C]) New(agentId, source any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerFactoryMockRecorder[C]) SourcesFromConfiguration(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

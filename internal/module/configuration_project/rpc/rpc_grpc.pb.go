...
const (
	ConfigurationProject_ListAgentConfigFiles_FullMethodName = "/gitlab.agent.configuration_project.rpc.ConfigurationProject/ListAgentConfigFiles"
)
...
func (c *configurationProjectClient) ListAgentConfigFiles(ctx context.Context, in *ListAgentConfigFilesRequest, opts ...grpc.CallOption) (*ListAgentConfigFilesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConfigurationProject_ListAgentConfigFiles_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConfigurationProject_ListAgentConfigFiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConfigurationProject_ListAgentConfigFiles_FullMethodName,
	}

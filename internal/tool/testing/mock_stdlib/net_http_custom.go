...
//
//	mockgen -destination net_http_custom.go -package mock_stdlib gitlab.com/gitlab-org/cluster-integration/gitlab-agent/v16/internal/tool/testing/mock_stdlib ResponseWriterFlusher
//
...
func (mr *MockResponseWriterFlusherMockRecorder) WriteHeader(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

...
//
//	mockgen -source ../../redistool/expiring_hash.go -destination expiring_hash.go -package mock_redis
//
...
func (mr *MockExpiringHashMockRecorder[K1, K2]) Clear(arg0 any) *gomock.Call {
...
func (mr *MockExpiringHashMockRecorder[K1, K2]) Forget(key, hashKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockExpiringHashMockRecorder[K1, K2]) Len(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockExpiringHashMockRecorder[K1, K2]) Refresh(ctx, nextRefresh any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockExpiringHashMockRecorder[K1, K2]) Scan(ctx, key, cb any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockExpiringHashMockRecorder[K1, K2]) Set(ctx, key, hashKey, value any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockExpiringHashMockRecorder[K1, K2]) Unset(ctx, key, hashKey any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

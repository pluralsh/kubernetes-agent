...
//
//	mockgen -source ../../redistool/expiring_hash_api_set_builder.go -destination expiring_hash_api_set_builder.go -package mock_redis
//
...
func (mr *MockSetBuilderMockRecorder[K1, K2]) Do(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Do", reflect.TypeOf((*MockSetBuilder[K1, K2])(nil).Do), arg0)
}
...
func (mr *MockSetBuilderMockRecorder[K1, K2]) Set(key, ttl any, kvs ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{key, ttl}, kvs...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockSetBuilder[K1, K2])(nil).Set), varargs...)
}

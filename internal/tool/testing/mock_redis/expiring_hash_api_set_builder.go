...
func (mr *MockSetBuilderMockRecorder[K1, K2]) Do(arg0 interface{}) *gomock.Call {
...
func (mr *MockSetBuilderMockRecorder[K1, K2]) Set(key, ttl interface{}, kvs ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{key, ttl}, kvs...)

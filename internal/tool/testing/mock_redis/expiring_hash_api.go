...
func (mr *MockExpiringHashApiMockRecorder[K1, K2]) Scan(ctx, key, cb interface{}) *gomock.Call {
...
func (mr *MockExpiringHashApiMockRecorder[K1, K2]) Unset(ctx, key, hashKey interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()

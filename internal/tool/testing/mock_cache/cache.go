...
//
//	mockgen -source ../../cache/cache_with_err.go -destination cache.go -package mock_cache
//
...
func (mr *MockErrCacherMockRecorder[K]) CacheError(ctx, key, err, errTtl any) *gomock.Call {
...
func (mr *MockErrCacherMockRecorder[K]) GetError(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

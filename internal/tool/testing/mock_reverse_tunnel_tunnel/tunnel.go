...
//
//	mockgen -typed -destination tunnel.go -package mock_reverse_tunnel_tunnel gitlab.com/gitlab-org/cluster-integration/gitlab-agent/v16/internal/module/reverse_tunnel/tunnel Tracker,Handler,FindHandle,Tunnel,PollingQuerier,Finder
//

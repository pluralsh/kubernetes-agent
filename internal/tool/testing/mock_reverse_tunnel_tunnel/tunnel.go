...
// Source: gitlab.com/gitlab-org/cluster-integration/gitlab-agent/v16/internal/module/reverse_tunnel/tunnel (interfaces: Registerer,Handler,FindHandle,Tunnel,PollingQuerier,Finder)

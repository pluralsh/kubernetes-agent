...
// Source: gitlab.com/gitlab-org/cluster-integration/gitlab-agent/v16/internal/module/reverse_tunnel/tunnel (interfaces: Registerer,TunnelHandler,FindHandle,Tunnel,PollingQuerier,TunnelFinder)

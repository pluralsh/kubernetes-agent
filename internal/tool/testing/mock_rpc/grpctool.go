...
// Source: gitlab.com/gitlab-org/cluster-integration/gitlab-agent/v15/internal/tool/grpctool (interfaces: InboundGrpcToOutboundHttpStream,PoolConn,PoolInterface)

...
func (m *MockRpcApi) AgentInfo(arg0 context.Context, arg1 *zap.Logger) (*api.AgentInfo, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRpcApiMockRecorder) AgentInfo(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AgentInfo", reflect.TypeOf((*MockRpcApi)(nil).AgentInfo), arg0, arg1)
}

// AgentToken mocks base method.
func (m *MockRpcApi) AgentToken() api.AgentToken {
	m.ctrl.T.Helper()

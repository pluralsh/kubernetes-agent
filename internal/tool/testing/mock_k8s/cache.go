...
//
//	mockgen -destination cache.go -package mock_k8s k8s.io/client-go/tools/cache Indexer,GenericLister,GenericNamespaceLister
//
...
func (mr *MockGenericListerMockRecorder) ByNamespace(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Get indicates an expected call of Get.
func (mr *MockGenericListerMockRecorder) Get(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// List indicates an expected call of List.
func (mr *MockGenericListerMockRecorder) List(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Get indicates an expected call of Get.
func (mr *MockGenericNamespaceListerMockRecorder) Get(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// List indicates an expected call of List.
func (mr *MockGenericNamespaceListerMockRecorder) List(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

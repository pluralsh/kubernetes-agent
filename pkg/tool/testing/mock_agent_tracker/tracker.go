...
func (m *MockTracker) GetConnectionsByAgentId(arg0 context.Context, arg1 int64, arg2 agent_tracker2.ConnectedAgentInfoCallback) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *TrackerGetConnectionsByAgentIdCall) Do(f func(context.Context, int64, agent_tracker2.ConnectedAgentInfoCallback) error) *TrackerGetConnectionsByAgentIdCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *TrackerGetConnectionsByAgentIdCall) DoAndReturn(f func(context.Context, int64, agent_tracker2.ConnectedAgentInfoCallback) error) *TrackerGetConnectionsByAgentIdCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// GetConnectionsByProjectId mocks base method.
func (m *MockTracker) GetConnectionsByProjectId(arg0 context.Context, arg1 int64, arg2 agent_tracker2.ConnectedAgentInfoCallback) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *TrackerGetConnectionsByProjectIdCall) Do(f func(context.Context, int64, agent_tracker2.ConnectedAgentInfoCallback) error) *TrackerGetConnectionsByProjectIdCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *TrackerGetConnectionsByProjectIdCall) DoAndReturn(f func(context.Context, int64, agent_tracker2.ConnectedAgentInfoCallback) error) *TrackerGetConnectionsByProjectIdCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// RegisterConnection mocks base method.
func (m *MockTracker) RegisterConnection(arg0 context.Context, arg1 *agent_tracker2.ConnectedAgentInfo) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *TrackerRegisterConnectionCall) Do(f func(context.Context, *agent_tracker2.ConnectedAgentInfo) error) *TrackerRegisterConnectionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *TrackerRegisterConnectionCall) DoAndReturn(f func(context.Context, *agent_tracker2.ConnectedAgentInfo) error) *TrackerRegisterConnectionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockTracker) UnregisterConnection(arg0 context.Context, arg1 *agent_tracker2.ConnectedAgentInfo) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *TrackerUnregisterConnectionCall) Do(f func(context.Context, *agent_tracker2.ConnectedAgentInfo) error) *TrackerUnregisterConnectionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *TrackerUnregisterConnectionCall) DoAndReturn(f func(context.Context, *agent_tracker2.ConnectedAgentInfo) error) *TrackerUnregisterConnectionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

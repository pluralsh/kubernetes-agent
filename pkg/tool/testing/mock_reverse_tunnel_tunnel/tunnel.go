...
// Source: github.com/pluralsh/kuberentes-agent/internal/module/reverse_tunnel/tunnel (interfaces: Tracker,Handler,FindHandle,Tunnel,PollingQuerier,Finder)
//
// Generated by this command:
//
//	mockgen -typed -destination tunnel.go -package mock_reverse_tunnel_tunnel github.com/pluralsh/kuberentes-agent/internal/module/reverse_tunnel/tunnel Tracker,Handler,FindHandle,Tunnel,PollingQuerier,Finder
//
...
func (m *MockFindHandle) Get(arg0 context.Context) (tunnel2.Tunnel, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].(tunnel2.Tunnel)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *FindHandleGetCall) Return(arg0 tunnel2.Tunnel, arg1 error) *FindHandleGetCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *FindHandleGetCall) Do(f func(context.Context) (tunnel2.Tunnel, error)) *FindHandleGetCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *FindHandleGetCall) DoAndReturn(f func(context.Context) (tunnel2.Tunnel, error)) *FindHandleGetCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockTunnel) ForwardStream(arg0 *zap.Logger, arg1 tunnel2.RpcApi, arg2 grpc.ServerStream, arg3 tunnel2.DataCallback) error {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *TunnelForwardStreamCall) Do(f func(*zap.Logger, tunnel2.RpcApi, grpc.ServerStream, tunnel2.DataCallback) error) *TunnelForwardStreamCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *TunnelForwardStreamCall) DoAndReturn(f func(*zap.Logger, tunnel2.RpcApi, grpc.ServerStream, tunnel2.DataCallback) error) *TunnelForwardStreamCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockPollingQuerier) PollKasUrlsByAgentId(arg0 context.Context, arg1 int64, arg2 tunnel2.PollKasUrlsByAgentIdCallback) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *PollingQuerierPollKasUrlsByAgentIdCall) Do(f func(context.Context, int64, tunnel2.PollKasUrlsByAgentIdCallback)) *PollingQuerierPollKasUrlsByAgentIdCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *PollingQuerierPollKasUrlsByAgentIdCall) DoAndReturn(f func(context.Context, int64, tunnel2.PollKasUrlsByAgentIdCallback)) *PollingQuerierPollKasUrlsByAgentIdCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockFinder) FindTunnel(arg0 context.Context, arg1 int64, arg2, arg3 string) (bool, tunnel2.FindHandle) {
	m.ctrl.T.Helper()
...
// Return rewrite *gomock.Call.Return
func (c *FinderFindTunnelCall) Return(arg0 bool, arg1 tunnel2.FindHandle) *FinderFindTunnelCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *FinderFindTunnelCall) Do(f func(context.Context, int64, string, string) (bool, tunnel2.FindHandle)) *FinderFindTunnelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *FinderFindTunnelCall) DoAndReturn(f func(context.Context, int64, string, string) (bool, tunnel2.FindHandle)) *FinderFindTunnelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

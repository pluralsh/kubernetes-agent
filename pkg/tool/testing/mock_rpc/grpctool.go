...
// Source: github.com/pluralsh/kuberentes-agent/pkg/tool/grpctool (interfaces: InboundGrpcToOutboundHttpStream,PoolConn,PoolInterface,ServerErrorReporter)
//
// Generated by this command:
//
//	mockgen -typed -destination grpctool.go -package mock_rpc github.com/pluralsh/kuberentes-agent/pkg/tool/grpctool InboundGrpcToOutboundHttpStream,PoolConn,PoolInterface,ServerErrorReporter
//
...
// Do rewrite *gomock.Call.Do
func (c *InboundGrpcToOutboundHttpStreamSendCall) Do(f func(*grpctool.HttpResponse) error) *InboundGrpcToOutboundHttpStreamSendCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *InboundGrpcToOutboundHttpStreamSendCall) DoAndReturn(f func(*grpctool.HttpResponse) error) *InboundGrpcToOutboundHttpStreamSendCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// Return rewrite *gomock.Call.Return
func (c *PoolInterfaceDialCall) Return(arg0 grpctool.PoolConn, arg1 error) *PoolInterfaceDialCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *PoolInterfaceDialCall) Do(f func(context.Context, string) (grpctool.PoolConn, error)) *PoolInterfaceDialCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *PoolInterfaceDialCall) DoAndReturn(f func(context.Context, string) (grpctool.PoolConn, error)) *PoolInterfaceDialCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

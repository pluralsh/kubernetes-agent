...
// Source: gitlab.com/gitlab-org/cluster-integration/gitlab-agent/v14/cmd/kas/kasapp (interfaces: KasPool,ClientConnInterface,SentryHub)
...
func (m *MockSentryHub) CaptureEvent(arg0 *sentry_go.Event) *sentry_go.EventID {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CaptureEvent", arg0)
	ret0, _ := ret[0].(*sentry_go.EventID)
	return ret0
}

...
//
//	mockgen -destination mock_for_test.go -package kasapp gitlab.com/gitlab-org/cluster-integration/gitlab-agent/v16/cmd/kas/kasapp SentryHub
//
...
func (mr *MockSentryHubMockRecorder) CaptureEvent(arg0 any) *gomock.Call {

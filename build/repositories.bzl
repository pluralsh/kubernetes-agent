...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:4u44IbgntN1yKgnY/mUabRjHXIchrLPwUwMuDyQ0+ec=",
        version = "v14.0.0-rc1",
    )
    go_repository(
        ...
        sum = "h1:kpjsME7190UdM3r8lBrSF2HZaYWJYvColDjhI/jcEjc=",
        version = "v15.1.0-rc1",
    )
    ...
    go_repository(
        ...
        sum = "h1:0yX0GPyvbc+yAEWwWlhgHlPF7JtvlLco6HjolSWewt4=",
        version = "v0.31.2",
    )
    go_repository(

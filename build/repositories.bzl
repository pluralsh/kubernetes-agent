...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:h6k2Bb0HWS/BXXHCXj4QHjxPmlIU4NK+7MuLp9SD+4k=",
        version = "v1.66.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BAlskWIiPSBtFrsIZXABaBR6mRCEWyvXoCvnQzKH7xk=",
        version = "v15.3.3",
    )
    go_repository(
        ...
        sum = "h1:ZtuWpT5keasYaZJ12XChuKYd2wMYBt8WgkBm9QmsJfY=",
        version = "v14.10.0",
    )
    go_repository(

...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:JcFf/BnOaMWe9ObjaklgbbF0bGXI4XbYJwYn2eFNVyQ=",
        version = "v1.44.200",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:iTFYCAdKzSAjGnVIUe88Hxvix0uaBqr0Rv7qJEOX5hE=",
        version = "v1.11.51",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:FGvpyTg2LKEmMrLlpjOgkoNp9XF5CGeyAyo33LdqZW8=",
        version = "v1.0.19",
    )
    ...
    go_repository(
        ...
        sum = "h1:5EQWIFO+Hc8E2hFcXQJ1vm6ufl/PMt/6RVRDZRju2vM=",
        version = "v1.30.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:NheeISPSUcYftKlfrLuOo4T62FkmD4t4jviLfFFYaec=",
        version = "v1.2.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:EB7M2v8Svo3kvIDy+P1YDE22XskDQP+TEYGzeDwPAN4=",
    ...
    go_repository(
        ...
        sum = "h1:+Tje+xk1lmGKSJjYNtgCFsU1HtQzz0kCm1DFbKlvFBo=",
    ...
    go_repository(
        ...
        sum = "h1:cbRy9akD9/hDD7BaVifyNkWkURwC8RSPLzX9+siS+OE=",
        version = "v3.3.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:tf/VU6zL1kxa3he+nf6FO/syX+LGkm6WGDsMpfuXV7Q=",
        version = "v2.1.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Fp3UnJmLVISmlc57BgKUzdjr0lOtjqTZicL3PaYy6cU=",
        version = "v1.2.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:G769v8covTkOiNckXFIwLx01XE04OE6Fr0JPA0oR2nI=",
        version = "v0.42.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:L6S7kR7SlhQKplIBpkra3s6yhcZV51lhRnXmYc4HohI=",
        version = "v0.0.0-20230426101702-58e86b294756",
    )
    ...
    go_repository(
        ...
        sum = "h1:Tw7M7TI1Jo1O1kdMywW8f+wo9Ij6JJr7dnt3NfUakBQ=",
        version = "v9.0.4",
    )
    go_repository(
        ...
        sum = "h1:1dFrr+SDSckfj5fmPnZ4WDbArTKgPHuAY1ax9IbyWew=",
        version = "v9.0.4",
    )
    go_repository(
        ...
        sum = "h1:3avVHKLqp4ne7tQI7YHpdOxmInYxH87uWSVqoCc3TJA=",
        version = "v9.0.4",
    )
    ...
    go_repository(
        ...
        sum = "h1:4swIpHXLMAz14DE4YTgakgadpRN0n1wE1dieGnOTVFU=",
        version = "v1.0.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:kyl+ovUoId/RSBbSbCm31xyQvPixA6Sxgvb0eWyt1Ko=",
        version = "v0.7.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:tycGb5QkQKGW12tYbSxhqlB4wuRGzxqIYkEggOHszoA=",
        version = "v15.11.0-rc1.0.20230510062852-cc1d527d01e8",
    )
    ...
    go_repository(
        ...
        sum = "h1:uYCIqDt/5V1hLIecTR4UNc1sD2+xiYplyKeyfpNN26A=",
        version = "v1.18.0",
    )
    ...
    go_repository(
        ...
        sum = "h1:gpTUYnqthem4+o8kyTLiYIB05W+IvdQFYR29erfe8uU=",
        version = "v1.0.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:qSG2PmtcD23BkYiWfoYAcak870eF/hE7NNYBYavTT94=",
        version = "v0.26.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rZccKdBLg9vP6J09JD+z8Yr99Ce8gk3Lbi9TCx05Jzs=",
        version = "v0.26.4",
    )
    go_repository(
        ...
        sum = "h1:3Oq4mnJv0mzVX7BR/Nod+8KjlELf/3Ljvu9ZWDyLUoA=",
        version = "v0.26.4",
    )
    go_repository(
        ...
        sum = "h1:MgSU871KDzBDX7V9GtuqS6Ai9lhQCHgRzkurnXOWtZ0=",
        version = "v0.26.4",
    )
    go_repository(
        ...
        sum = "h1:/7P/IbGBuT73A+G97trf44NTPSNqvuBREpOfdLbHvD4=",
        version = "v0.26.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Bg2xzyXNKL3eAuiTEu3XE198d6z22ENgFgGQv2GGOUk=",
        version = "v0.26.4",
    )
    go_repository(
        ...
        sum = "h1:qbZrh8QmfL+Yn7lWEI/BPrvITGgkBy33djP5Tzsu2hA=",
        version = "v0.26.4",
    )
    go_repository(
        name = "io_k8s_cri_api",
    ...
    go_repository(
        ...
        sum = "h1:mQ+DeOvgAHC6+heZcozPkEd3rWtP4DVVjo1hLSih9w4=",
        version = "v0.26.4",
    )
    ...
    go_repository(
        ...
        sum = "h1:A0Oa0u/po4KxXnXsNCOwLojAe9cQR3TJNJabEIf7U1w=",
        version = "v0.26.4",
    )
    ...
    go_repository(
        ...
        sum = "h1:ijyerycmjVp9EVPfDqha8eb+s9jw5c+A9MkTvuRBdms=",
        version = "v0.26.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Yi+45UDdZpL6bt8dgfK9qlYL6zAdeUoXCwlHNn9RnZM=",
        version = "v0.34.1-0.20230320211711-ed4ec48b3405",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:n1X5yaQTP5DYywlBOZMl2gX398Gp6YwFp/IAVj6+5D4=",
        version = "v3.11.3",
    )
